...
https://claude.ai/chat/6ef4da85-5bef-43ba-80bd-33a156d76f88
...
Select in visual line mode (V key) and press = to re-indent the selection (for source code) or gq to reformat the selection (for text).
See :help gq and :help = for details of how each works and can be customised.
https://www.reddit.com/r/neovim/comments/11biinx/format_selection_instead_of_entire_file/
...
vep - 'change word' using current paste buffer https://unix.stackexchange.com/questions/88714/how-can-i-do-a-change-word-in-vim-using-the-current-paste-buffer
sr({ - replace surroundings https://github.com/echasnovski/mini.surround
...
-- Key mapping to flip boolean (using <leader>b for "boolean")
vim.keymap.set('n', '<leader>b', flip_boolean, { desc = 'Flip boolean value under cursor' })
...
require('lazy').setup {
  ...
  { 'akinsho/git-conflict.nvim', version = '*', config = true }, -- Git Conflict Resolve
  ...
  },
  {
    ...
    init = function()
      vim.g.VM_maps = nil
      vim.g.VM_maps = {
        ['Add Cursor Down'] = 'âˆ†', --/ M-j
        ['Add Cursor Up'] = 'Ëš', --/ M-k
      }
    end,
  },
